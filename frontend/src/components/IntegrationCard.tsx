...
import { Github, FileText, Pencil, Trash2, Check, AlertCircle, Loader2 } from 'lucide-react'
...
export function IntegrationCard({ integration, onEdit, onDelete, index }: IntegrationCardProps) {
